...
class ClusterHullProfile :
    ...
    def __init__(self, Ly, xmax, xmin, frame_init, frame_fin, read_folder, save_folder,
                left_int=1, root='cv', movie=False, movie_name="contact_line_alpha.mp4") :
...
def main() :
    ...
    frame_init = 1
    frame_fin = 3500
    read_folder = '/home/michele/BeskowDiag/Select_Q3_Equil/TrjGroBL'
    save_folder = '/home/michele/densmap/ContactLineProfiles/EquilQ3BL'

    test_cl = ClusterHullProfile(Ly, xmax, xmin, frame_init, frame_fin, read_folder, save_folder, movie=False, movie_name="q3_eq_alpha_shape.mp4")
