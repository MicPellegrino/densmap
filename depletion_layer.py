...
plt.plot(time_vector, bulk_density_vec, 'ko-', linewidth=1.5, markeredgewidth=2.5, markersize=7.5, label='bulk density')
plt.legend(fontsize=20.0)
plt.xlabel('t [ps]', fontsize=20.0)
plt.ylabel(r'$\rho$ [amu/nm^2]', fontsize=20.0)
plt.xticks(fontsize=20.0)
plt.yticks(fontsize=20.0)
plt.show()

plt.plot(bulk_density_vec, depletion_layer, 'kx', linewidth=1.5, markeredgewidth=2.5, markersize=7.5)
plt.xlabel(r'$\rho$ [amu/nm^2]', fontsize=20.0)
plt.ylabel(r'$\delta$ [nm]', fontsize=20.0)
plt.xticks(fontsize=20.0)
plt.yticks(fontsize=20.0)
