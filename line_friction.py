...
sigma_ang = 5.0
angle_l_filtered = smg.gaussian_filter1d(angle_l, sigma=sigma_pos)
angle_r_filtered = smg.gaussian_filter1d(angle_r, sigma=sigma_pos)
...
velocity_l_micro = velocity_l_filtered * area_proj(foot_l)
velocity_r_micro = velocity_r_filtered * area_proj(foot_r)

# Obtain the microscopic contact angle
angle_l_micro = angle_l - alpha_sub(foot_l)
angle_r_micro = angle_r - alpha_sub(foot_r)
angle_l_micro_filtered = smg.gaussian_filter1d(angle_l_micro, sigma=sigma_pos)
angle_r_micro_filtered = smg.gaussian_filter1d(angle_r_micro, sigma=sigma_pos)
...
plt.plot(time, foot_l, 'b-', linewidth=0.75)
plt.plot(time, foot_r, 'r-', linewidth=0.75)
plt.plot(time, foot_l_filtered, 'b--', linewidth=2.0)
plt.plot(time, foot_r_filtered, 'r--', linewidth=2.0)
...
plt.plot(time, velocity_l_micro, 'b-', linewidth=1.5)
plt.plot(time, velocity_r_micro, 'r-', linewidth=1.5)
plt.xlabel('t [ps]', fontsize=20.0)
...
plt.plot(time, angle_l_micro, 'b-', linewidth=0.75)
plt.plot(time, angle_r_micro, 'r-', linewidth=0.75)
plt.plot(time, angle_l_micro_filtered, 'b--', linewidth=2.0)
plt.plot(time, angle_r_micro_filtered, 'r--', linewidth=2.0)
plt.xlabel('t [ps]', fontsize=20.0)
plt.ylabel(r'$\theta$ [deg]', fontsize=20.0)
plt.show()

plt.title('Correlation between c.a. and c.l. speed')
plt.plot(cos(angle_l_micro_filtered), velocity_l_micro, 'bx')
plt.plot(cos(angle_r_micro_filtered), velocity_r_micro, 'ro')
plt.xlabel(r'$cos(\theta)$ [-1]', fontsize=20.0)
plt.ylabel('dx/dt [nm/ps]', fontsize=20.0)
plt.show()
