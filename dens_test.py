...
left_branch, right_branch, points_l, points_r = \
    dm.detect_contact_line(intf_contour, z_min=1.0, z_max=6.0, x_half=0.5*Lx, m=10, d=10)
...
plt.plot(intf_contour[0,:], intf_contour[1,:], 'r-', linewidth=3.0, label='half density')
# plt.plot(left_branch[0,:], left_branch[1,:], 'b--', \
#     right_branch[0,:], right_branch[1,:], 'b--', linewidth=1.5)
