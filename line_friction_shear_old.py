...
if charge_label=='Q1' :
    avg_theta_0 = 124.85899804168973
    std_theta_0 = 3.7292178915609497
    Ca_cr = 0.90
    folders = [ 'ShearDynamic/Q1_Ca005', 
            'ShearDynamic/Q1_Ca010', 
            'ShearDynamic/Q1_Ca030',
            'ShearDynamic/Q1_Ca060' ]
    capillary_number = np.array([ 0.05, 0.10, 0.30, 0.60])

elif charge_label=='Q2' :
...
elif charge_label=='Q4' :
    avg_theta_0 = 42.75912300977666
    std_theta_0 = 2.9066340937619715
    Ca_cr = 0.025
    folders = [ 'ShearDynamic/Q4_Ca0015', 
            'ShearDynamic/Q4_Ca002', ]
    capillary_number = np.array([ 0.015, 0.02])
...
print("theta_a =    "+str(avg_angle_adv))
print("theta_r =    "+str(avg_angle_rec))
print("std_a   =    "+str(std_angle_adv))
print("std_r   =    "+str(std_angle_rec))
...
capillary_adv = np.linspace(0, max(capillary_number), 100)
capillary_rec = np.linspace(-max(capillary_number), 0.0, 100)
