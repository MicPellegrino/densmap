...
for k in range(len(charges)):
    ...
    """
    plt.plot(time[charges[k]], spreading_angle[charges[k]], label='q='+str(q_vals[k]), \
    linewidth=2.00, c=cm.hot((q_max-q_vals[k])/(1.5*q_diff)))
